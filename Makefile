...
install:
	...
	MICROSERVICE_PATH=jobs/ml_jobs/offer_recommendation PHYTON_VENV_VERSION=3.10.4 VENV_NAME=data-gcp-offer-recommendation REQUIREMENTS_NAME=requirements.txt RECREATE_VENV=$(CLEAN_INSTALL) make install_microservice
