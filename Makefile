install:
	...
	pyenv local 3.7.7
	(pyenv virtualenv data-gcp-api || echo "pyenv-virtualenv data-gcp already exists") && pyenv local data-gcp && pip install --upgrade pip && pip install -r api-dev-requirements.txt
