...
install:
	...
	MICROSERVICE_PATH=jobs/ml_jobs/record_linkage_updated PHYTON_VENV_VERSION=3.10.4 VENV_NAME=data-gcp-record-linkage-updated REQUIREMENTS_NAME=requirements.txt RECREATE_VENV=$(CLEAN_INSTALL) make install_microservice
