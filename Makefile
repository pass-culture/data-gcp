...
sqlfmt_fix:
	sqlfmt orchestration/dags/data_gcp_dbt/models/export orchestration/dags/data_gcp_dbt/models/clean orchestration/dags/dependencies --exclude "**/.venv/**" --exclude "orchestration/dags/data_gcp_dbt/target/dbt_packages/**" --exclude "*/venv/**" --exclude "**/orchestration/dags/dependencies/applicative_database/sql/raw/**"

sqlfmt_check:
	sqlfmt --check orchestration/dags/data_gcp_dbt/models/export orchestration/dags/data_gcp_dbt/models/clean orchestration/dags/dependencies --exclude "**/.venv/**" --exclude "orchestration/dags/data_gcp_dbt/target/dbt_packages/**" --exclude "*/venv/**" --exclude "**/orchestration/dags/dependencies/applicative_database/sql/raw/**"
