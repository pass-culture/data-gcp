...
def get_bookings(start_date, end_date):
    query = f"""
        ...
        offer.offer_subcategoryId as offer_subcategoryid, count(*) as nb_bookings, enroffer.genres, enroffer.rayon, enroffer.type, enroffer.venue_id, enroffer.venue_name
        ...
        group by user_id, offer_id, offer_subcategoryid,enroffer.genres, enroffer.rayon, enroffer.type, enroffer.venue_id, enroffer.venue_name
    """
