...
from analytics.config import MIGRATION_ENRICHED_BOOKING_DATA
...
def main(dataset):
    ...
    # Define query
    overall_query = define_enriched_booking_data_full_query(dataset=dataset)
...
if __name__ == "__main__":
    set_env_vars()
    main(dataset=MIGRATION_ENRICHED_BOOKING_DATA)
