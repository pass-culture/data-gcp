...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "id" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "dateCreated" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "stockId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "quantity" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "userId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "amount" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "isCancelled" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "isUsed" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "dateUsed" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.booking WHERE "cancellationDate" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "isActive" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "thumbCount" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "idAtProviders" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "dateModifiedAtLastProvider" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "address" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "postalCode" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "city" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "id" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "dateCreated" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "name" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "siren" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "lastProviderId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offerer WHERE "fieldsUpdated" IS NULL')
) as count_null_in_offerer_fields_updated_csql,
(
  SELECT count(offerer_id) FROM `passculture-data-prod.analytics_prod.applicative_database_offerer` WHERE offerer_fields_updated IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "idAtProviders" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "dateModifiedAtLastProvider" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "id" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "dateCreated" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "productId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "venueId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "lastProviderId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "bookingEmail" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "isActive" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "type" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "name" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "description" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "ageMin" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "ageMax" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "url" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "durationMinutes" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "isNational" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "extraData" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "isDuo" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "fieldsUpdated" IS NULL')
) as count_null_in_offer_fields_updated_csql,
(
  SELECT count(offer_id) FROM `passculture-data-prod.analytics_prod.applicative_database_offer` WHERE offer_fields_updated IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.offer WHERE "withdrawalDetails" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "thumbCount" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "idAtProviders" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "dateModifiedAtLastProvider" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "address" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "postalCode" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "city" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "id" IS NULL')
) as count_null_in_venue_id_csql,
(
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "name" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "siret" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "departementCode" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "latitude" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "longitude" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "managingOffererId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "bookingEmail" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "isVirtual" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "comment" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "publicName" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "fieldsUpdated" IS NULL')
) as count_null_in_venue_fields_updated_csql,
(
  SELECT count(venue_id) FROM `passculture-data-prod.analytics_prod.applicative_database_venue` WHERE venue_fields_updated IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "venueTypeId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "venueLabelId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.venue WHERE "dateCreated" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "idAtProviders" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "dateModifiedAtLastProvider" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "id" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "dateModified" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "price" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "quantity" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "bookingLimitDatetime" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "lastProviderId" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "offerId" IS NULL')
) as count_null_in_offer_id_csql,
(
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "isSoftDeleted" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "beginningDatetime" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "dateCreated" IS NULL')
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.stock WHERE "fieldsUpdated" IS NULL')
) as count_null_in_stock_fields_updated_csql,
(
  SELECT count(stock_id) FROM `passculture-data-prod.analytics_prod.applicative_database_stock` WHERE stock_fields_updated IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "id" IS NULL')
) as count_null_in_id_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_id IS NULL
) as count_null_in_id_big_query
UNION ALL
SELECT
(
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "dateCreated" IS NULL')
) as count_null_in_dateCreated_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_creation_date IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "departementCode" IS NULL')
) as count_null_in_departement_code_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_department_code IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "isBeneficiary" IS NULL')
) as count_null_in_is_beneficiary_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_is_beneficiary IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "isAdmin" IS NULL')
) as count_null_in_is_Admin_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_is_admin IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "resetPasswordTokenValidityLimit" IS NULL')
) as count_null_in_reset_psw_token_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_reset_password_token_validity_limit IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "postalCode" IS NULL')
) as count_null_in_postal_code_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_postal_code IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "needsToFillCulturalSurvey" IS NULL')
) as count_null_in_user_needs_to_fill_cultural_survey_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_needs_to_fill_cultural_survey IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "culturalSurveyId" IS NULL')
) as count_null_in_user_cultural_survey_id_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_cultural_survey_id IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "civility" IS NULL')
) as count_null_in_user_civility_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_civility IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "activity" IS NULL')
) as count_null_in_user_activity_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_activity IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "culturalSurveyFilledDate" IS NULL')
) as count_null_in_user_cultural_survey_filled_date_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_cultural_survey_filled_date IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "hasSeenTutorials" IS NULL')
) as count_null_in_user_has_seen_tutorials_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_has_seen_tutorials IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "address" IS NULL')
) as count_null_in_user_address_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_address IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "city" IS NULL')
) as count_null_in_user_city_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_city IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "lastConnectionDate" IS NULL')
) as count_null_in_user_last_connection_date_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_last_connection_date IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "isEmailValidated" IS NULL')
) as count_null_in_user_is_email_validated_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_is_email_validated IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "hasAllowedRecommendations" IS NULL')
) as count_null_in_user_has_allowed_recommendations_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_has_allowed_recommendations IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "suspensionReason" IS NULL')
) as count_null_in_user_suspension_reason_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_suspension_reason IS NULL
...
(
  SELECT count(id) FROM EXTERNAL_QUERY('passculture-metier-prod.europe-west1.metier-pcapi-production-connection', 'SELECT id FROM public.user WHERE "isActive" IS NULL')
) as count_null_in_user_is_active_csql,
(
  SELECT count(user_id) FROM `passculture-data-prod.analytics_prod.applicative_database_user` WHERE user_is_active IS NULL
