...
def define_enriched_offerer_data_full_query(dataset):
    return f"""
        {define_first_stock_creation_dates_query(dataset=dataset)}
        {define_first_booking_creation_dates_query(dataset=dataset)}
        {define_number_of_offers_query(dataset=dataset)}
        {define_number_of_bookings_not_cancelled_query(dataset=dataset)}
        {define_offerer_departement_code_query(dataset=dataset)}
