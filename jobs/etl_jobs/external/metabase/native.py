class NativeCard:
    def __init__(self, card_id, metabase_api):
        ...
        self.query = self.card_info["legacy_query"]["native"]["query"]
    ...
    def replace_table_name(self, legacy_table_name, new_table_name):
        ...
        self.card_info["legacy_query"]["native"]["query"] = self.query
    ...
    def replace_column_names(self, column_mapping):
        ...
        self.card_info["legacy_query"]["native"]["query"] = new_query

    def update_filters(self, metabase_field_mapping):
        for _, d in self.card_info["legacy_query"]["native"]["template-tags"].items():
            if d["type"] == "dimension":
