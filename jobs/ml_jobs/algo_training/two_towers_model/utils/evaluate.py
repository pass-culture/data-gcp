...
def generate_predictions(
    ...
    """
    Generates item recommendations for each user in the test dataset using a brute-force
    nearest-neighbor index. The recommendations are computed using the user embeddings from
    the model's user tower.
    ...
    # Initialize an exact brute-force nearest-neighbor index over the item embeddings.
    logger.info("Initializing BruteForce index for item embeddings")
    ...
    for batch_start_index in tqdm(
        ...
        # Get recommendations using the brute-force index
