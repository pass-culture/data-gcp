...
class TestValidateParquetFile:
    def test_all_columns_present(self):
        ...
        vector = Vector(name="v", features=["feat"], encoder_name="model")
        _validate_parquet_file(df, vector)  # Should not raise
    ...
    def test_missing_feature_column(self):
        ...
        vector = Vector(name="v", features=["missing"], encoder_name="model")
