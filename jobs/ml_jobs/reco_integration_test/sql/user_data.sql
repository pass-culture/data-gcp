...
with
    ...
    users_clics as (
        ...
        from user_sample us
        join
            `passculture-data-prod.analytics_prod.native_event` fe
    ...
    base_booking as (
        ...
        join
            `passculture-data-prod.analytics_prod.global_booking` ebd
    ...
    enriched_interaction as (
        ...
        join
            `passculture-data-prod.analytics_prod.global_offer_metadata` eom
