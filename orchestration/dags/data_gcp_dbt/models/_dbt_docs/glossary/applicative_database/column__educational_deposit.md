{% docs column__scholar_year %} Id of the scholar year. {% enddocs %}
...
{% docs column__educational_deposit_period %} Period associated to the deposit (all year, sept-dec, janv-aout). {% enddocs %}
