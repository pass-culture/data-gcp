...
{% docs column__offer_description %} Description of the offer. {% enddocs %}
...
{% docs column__author %} Author of the reserved book, if applicable. {% enddocs %}
{% docs column__performer %} Performer or group for the reserved musical offer, if applicable. {% enddocs %}
...
{% docs column__gtl_label_level_1 %} Label of level 1 provided by Titelive. {% enddocs %}
{% docs column__gtl_label_level_2 %} Label of level 2 provided by Titelive. {% enddocs %}
{% docs column__gtl_label_level_3 %} Label of level 3 provided by Titelive. {% enddocs %}
{% docs column__gtl_label_level_4 %} Label of level 4 provided by Titelive. {% enddocs %}
{% docs column__offer_sub_type_label %} Deprecated: Legacy identifier. Prefer using GTL. {% enddocs %}
{% docs column__offer_type_id %} Deprecated: Legacy identifier. Prefer using GTL. {% enddocs %}
{% docs column__offer_sub_type_id %} Deprecated: Legacy identifier. Prefer using GTL.  {% enddocs %}
{% docs column__offer_type_label %} Deprecated: Legacy identifier. Prefer using GTL. {% enddocs %}
{% docs column__offer_type_labels %} Deprecated: Legacy identifier. Prefer using GTL. {% enddocs %}
{% docs column__titelive_gtl_id %} Titelive GTL identifier, if applicable. {% enddocs %}
{% docs column__gtl_type %} Is Titelive GTL related to BOOK or CD/Vinyle. {% enddocs %}
