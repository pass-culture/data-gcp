...
{% docs column__user_age_at_deposit %} The age of the user at the time of deposit, calculated as the difference between the deposit creation date and the user's date of birth. {% enddocs %}
