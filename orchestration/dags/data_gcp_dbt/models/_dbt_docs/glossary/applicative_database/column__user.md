...
{% docs column__user_first_deposit_beneficiary_type %} The first deposit beneficiary type associated with the user. {% enddocs %}
{% docs column__user_current_deposit_beneficiary_type %} The current deposit beneficiary type associated with the user. {% enddocs %}
