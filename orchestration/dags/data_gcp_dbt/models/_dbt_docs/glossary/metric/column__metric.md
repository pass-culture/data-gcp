...
{% docs column__p1_total_theoric_bookings %} Total non cancelled collective bookings made during period P1 (= sept-dec) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p2_total_theoric_bookings %} Total non cancelled collective bookings made during period P2 (= jan-aug) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p1_theoric_amount_spent %} Total amount associated to the number of non cancelled collective bookings made during period P1 (= sept-dec) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p2_theoric_amount_spent %} Total amount associated to the number of non cancelled collective bookings made during period P2 (= jan-aug) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p1_total_confirmed_bookings %} Total confirmed, used and reimbursed collective bookings made during period P1 (= sept-dec) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p2_total_confirmed_bookings %} Total confirmed, used and reimbursed collective bookings made during period P2 (= jan-aug) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p1_real_amount_spent %} Total amount associated to the number of used and reimbursed collective bookings made during period P1 (= sept-dec) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p2_real_amount_spent %} Total amount associated to the number of used and reimbursed collective bookings made during period P2 (= jan-aug) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p1_reimbursed_amount %} Total reimbursed amount during period P1 (= sept-dec) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__p2_reimbursed_amount %} Total reimbursed amount during period P2 (= jan-aug) - only for the institutions and scholar year with a split deposit.  {% enddocs %}
{% docs column__total_scholar_year_deposit %} Total amount of the educational deposit for the scholar year (if the deposit is split it is the sum of p1 and p2 deposit).  {% enddocs %}
{% docs column__all_year_total_theoric_bookings %} Total non cancelled collective bookings made during scholar year (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
{% docs column__all_year_theoric_amount_spent %} Total amount associated to the number of non cancelled collective bookings made during scholar year (if the deposit is split it is the sum of p1 and p2 deposit).  {% enddocs %}
{% docs column__pct_all_year_theoric_amount_spent %} All year theoric amount spent / all year deposit.  {% enddocs %}
{% docs column__pct_p1_theoric_amount_spent %} p1 theoric amount spent / p1 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__pct_p2_theoric_amount_spent %} p2 theoric amount spent / p2 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__all_year_total_confirmed_bookings %} Total confirmed, used and reimbursed collective bookings made during scholar year (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
{% docs column__all_year_real_amount_spent %} Total amount associated to the number of used and reimbursed collective bookings made during scholar year (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
{% docs column__pct_p1_real_amount_spent %} p1 real amount spent / p1 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__pct_p2_real_amount_spent %} p2 real amount spent / p2 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__pct_all_year_real_amount_spent %} Total scholar real amount spent / total scholar_year deposit (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
{% docs column__all_year_reimbursed_amount %} Total reimbursed amount during scholar year (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
{% docs column__is_split_deposit %} Whether or not the scholar year has one or two deposit.s associated. {% enddocs %}
{% docs column__p1_deposit %} Amount of first period deposit (p1 = sept-dec) - only for the institutions and scholar year with a split deposit. {% enddocs %}
{% docs column__p2_deposit %} Amount of second period deposit (p2 = jan-aug) - only for the institutions and scholar year with a split deposit. {% enddocs %}
{% docs column__pct_p1_reimbursed_amount_spent %} p1 reimbursed amount / p1 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__pct_p2_reimbursed_amount_spent %} p2 reimbursed amount / p2 deposit (only for the institutions and scholar year with a split deposit).  {% enddocs %}
{% docs column__pct_all_year_reimbursed_amount_spent %} Scholar year reimbursed amount / scholar year deposit (if the deposit is split it is the sum of p1 and p2).  {% enddocs %}
