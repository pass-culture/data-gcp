{% docs column__embedding_offer_name %}Embedding generated with the offer name.{% enddocs %}
...
{% docs column__semantic_content %}Embedding of item's metadata with the retrieval "search result" query prompt. Encoded with embedding-gemma-300m model.{% enddocs %}
