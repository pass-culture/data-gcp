{% docs column__instagram_publication_media_type %} The format of the Instagram publication content. Possible values include: PHOTO, VIDEO, CAROUSEL_ALBUM {% enddocs %}
