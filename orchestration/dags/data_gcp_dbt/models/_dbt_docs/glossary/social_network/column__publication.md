{% docs column__publication_id %} The unique identifier for the publication. Format varies by platform: numeric ID for Instagram, alphanumeric for TikTok. {% enddocs %}
