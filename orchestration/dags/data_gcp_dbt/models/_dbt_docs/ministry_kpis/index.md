---
title: Ministry Exports Guide
description: Documentation for ministry export tables with calculation examples for main indicators.
---
...
|------|---------------------|-------|
| [User and deposits](user_and_deposit.md) | `exp_ministry__user`, `exp_ministry__deposit` | Beneficiary lifecycle and credit stock |
| [Bookings](booking.md) | `exp_ministry__booking` (+ links to user/offer/stock keys) | Consumption, statuses, and transaction KPIs |
| [Offers and stocks](offer_and_stock.md) | `exp_ministry__offer`, `exp_ministry__stock`, `exp_ministry__offer_metadata` | Supply catalog and availability |
| [Offerers and venues](offerer_and_venue.md) | `exp_ministry__offerer`, `exp_ministry__venue` | Cultural actor and place network |
| [Geography tables](geography.md) | `exp_ministry__address`, `exp_ministry__user_address`, `exp_ministry__venue_address`, `exp_ministry__offerer_representation_address`, `exp_ministry__geo_iris` | Territorial segmentation and joins |
