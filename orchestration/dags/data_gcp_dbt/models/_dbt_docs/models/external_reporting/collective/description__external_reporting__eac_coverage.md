...
description: Key indicators from the `external_reporting__eac_coverage` model.
---

{% docs description__external_reporting__eac_coverage %}

The `external_reporting__eac_coverage` model provides aggregated key indicators related to pass Culture eac student coverage.
...
{% docs table__external_reporting__eac_coverage %}{% enddocs %}
