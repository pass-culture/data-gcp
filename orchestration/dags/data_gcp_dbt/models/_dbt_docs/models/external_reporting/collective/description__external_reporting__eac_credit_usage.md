...
description: Key indicators from the `external_reporting__eac_credit_usage` model.
---

{% docs description__external_reporting__eac_credit_usage %}

The `external_reporting__eac_credit_usage` model provides aggregated key indicators related to pass Culture eac student and institutions credit usage.
...
{% docs table__external_reporting__eac_credit_usage %}{% enddocs %}
