...
description: Key indicators from the `external_reporting__eac_institution` model.
---

{% docs description__external_reporting__eac_institution %}

The `external_reporting__eac_institution` model provides aggregated key indicators related to pass Culture eac institutions coverage.
...
{% docs table__external_reporting__eac_institution %}{% enddocs %}
