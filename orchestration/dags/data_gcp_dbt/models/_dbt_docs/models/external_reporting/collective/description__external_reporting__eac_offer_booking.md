...
description: Key indicators from the `external_reporting__eac_offer_booking` model.
---

{% docs description__external_reporting__eac_offer_booking %}

The `external_reporting__eac_offer_booking` model provides aggregated key indicators related to pass Culture eac offers and bookings.
...
{% docs table__external_reporting__eac_offer_booking %}{% enddocs %}
