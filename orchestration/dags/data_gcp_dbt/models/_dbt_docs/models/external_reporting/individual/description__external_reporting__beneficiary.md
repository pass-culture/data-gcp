...
description: Key indicators from the `external_reporting__beneficiary` model.
---

{% docs description__external_reporting__beneficiary %}

The `external_reporting__beneficiary` model provides aggregated key indicators related to pass Culture beneficiaries.
...
{% docs table__external_reporting__beneficiary %}{% enddocs %}
