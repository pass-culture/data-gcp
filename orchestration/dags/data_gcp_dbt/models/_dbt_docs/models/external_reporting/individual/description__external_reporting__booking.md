...
description: Key indicators from the `external_reporting__booking` model.
---

{% docs description__external_reporting__booking %}

The `external_reporting__booking` model provides aggregated key indicators related to pass Culture bookings.
...
{% docs table__external_reporting__booking %}{% enddocs %}
