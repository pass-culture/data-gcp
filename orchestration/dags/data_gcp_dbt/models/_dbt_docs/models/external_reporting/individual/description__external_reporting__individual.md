...
description: Key indicators from the `external_reporting__individual` model.
---

{% docs description__external_reporting__individual %}

The `external_reporting__individual` model provides aggregated key indicators related to pass Culture government priority politic for the individual part.
...
{% docs table__external_reporting__individual %}{% enddocs %}
