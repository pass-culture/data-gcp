...
description: Key indicators from the `mrt_external_reporting__eac_institution` model.
---

{% docs description__mrt_external_reporting__eac_institution %}

The `mrt_external_reporting__eac_institution` model provides aggregated key indicators related to pass Culture eac institutions coverage.
...
{% docs table__mrt_external_reporting__eac_institution %}{% enddocs %}
