...
description: Key indicators from the `external_reporting__coverage` model.
---

{% docs description__external_reporting__coverage %}

The `external_reporting__coverage` model provides aggregated key indicators related to pass Culture coverage.
...
{% docs table__external_reporting__coverage %}{% enddocs %}
