...
description: Key indicators from the `external_reporting__cultural_partner` model.
---

{% docs description__external_reporting__cultural_partner %}

The `external_reporting__cultural_partner` model provides aggregated key indicators related to pass Culture cultural partners.
...
{% docs table__external_reporting__cultural_partner %}{% enddocs %}
