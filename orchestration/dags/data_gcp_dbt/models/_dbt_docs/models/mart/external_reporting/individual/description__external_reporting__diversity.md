...
description: Key indicators from the `external_reporting__diversity` model.
---

{% docs description__external_reporting__diversity %}

The `external_reporting__diversity` model provides aggregated key indicators related to pass Culture diversity.
...
{% docs table__external_reporting__diversity %}{% enddocs %}
