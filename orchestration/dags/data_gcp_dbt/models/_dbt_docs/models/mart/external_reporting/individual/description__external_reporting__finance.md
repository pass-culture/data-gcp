...
description: Key indicators from the `external_reporting__finance` model.
---

{% docs description__external_reporting__finance %}

The `external_reporting__finance` model provides aggregated key indicators related to pass Culture amounts contributed, reimbursed and spent.
...
{% docs table__external_reporting__finance %}{% enddocs %}
