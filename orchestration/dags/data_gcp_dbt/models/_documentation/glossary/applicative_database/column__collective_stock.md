{% docs column__collective_stock_number_of_tickets %} Number of tickets available in the collective stock. {% enddocs %}
{% docs column__collective_stock_beginning_date_time %} Scheduled datetime of the event/show (if time event). {% enddocs %}
