...
aggregated_daily_user_used_bookings_history_1 AS (
    SELECT
        ...
        IF(EXTRACT(DAYOFYEAR FROM user_active_dates.active_date) < EXTRACT(DAYOFYEAR FROM user_active_dates.user_birth_date),
            DATE_DIFF(user_active_dates.active_date, user_active_dates.user_birth_date, YEAR) - 1,
            DATE_DIFF(user_active_dates.active_date, user_active_dates.user_birth_date, YEAR))  AS user_age,
