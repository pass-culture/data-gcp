...
SELECT
    ...
    COALESCE(individual_bookings_per_venue.total_individual_bookings,0) AS total_individual_bookings,
    COALESCE(collective_bookings_per_venue.total_collective_bookings,0) AS total_collective_bookings,
