...
with venue_data as (
    ...
    where
        (event_name in ('ConsultVenue', 'BookingConfirmation') or (event_name = 'ConsultOffer' and origin = 'venue'))
...
consult_offer as (
    ...
    from display
        left join venue_data on
            display.unique_session_id = venue_data.unique_session_id
...
from consult_offer
    left join venue_data on
        venue_data.unique_session_id = consult_offer.unique_session_id
