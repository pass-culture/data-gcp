...
from
    ...
    join {{ source('clean','applicative_database_collective_offer_history') }} as collective_offer
        on
    ...
    left join bookings_per_stock on
        collective_stock.collective_stock_id = bookings_per_stock.collective_stock_id
