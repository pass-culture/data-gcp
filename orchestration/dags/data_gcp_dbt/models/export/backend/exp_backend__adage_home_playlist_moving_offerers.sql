...
with
    random_template_offer_per_venue as (
        ...
        where (o.collective_offer_location_type = 'school' or o.collective_offer_venue_address_type = 'school') and collective_offer_is_active
    ...
    offerer_venue_info as (
        ...
        inner join
            ...
            and (o.collective_offer_location_type = 'school' or o.collective_offer_venue_address_type = 'school')
