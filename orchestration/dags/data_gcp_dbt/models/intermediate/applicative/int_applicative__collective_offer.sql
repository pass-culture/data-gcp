...
SELECT
    ...
    CASE WHEN co.contact_email IS NOT NULL THEN TRUE ELSE FALSE END AS collective_offer_contact_email,
    CASE WHEN co.contact_phone IS NOT NULL THEN TRUE ELSE FALSE END AS collective_offer_contact_phone,
