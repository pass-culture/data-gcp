WITH collective_bookings_grouped_by_collective_stock AS (
    ...
    SELECT
        ...
        SUM(CASE WHEN cb.collective_booking_status != 'CANCELLED' THEN cs.collective_stock_price END) AS collective_theoretic_revenue,
        SUM(CASE WHEN cb.collective_booking_status IN ('USED','REIMBURSED')THEN cs.collective_stock_price END) AS collective_real_revenue
...
SELECT cs.collective_stock_id,
    ...
    bcs.collective_theoretic_revenue,
    bcs.collective_real_revenue,
