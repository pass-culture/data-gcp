...
select
    ...
    case
        when d.type = "GRANT_15_17" then "15_17_pre_reform"
        when d.type = "GRANT_18" and d.amount = 300 then "18_pre_reform"
        when d.type = "GRANT_18" and d.amount > 300 then "18_experiment_phase"
        when d.type = "GRANT_17_18" and d.amount < 150 then "17_post_reform"
        when d.type = "GRANT_17_18" and d.amount >= 150 then "18_post_reform"
	  end as deposit_beneficiary_type
