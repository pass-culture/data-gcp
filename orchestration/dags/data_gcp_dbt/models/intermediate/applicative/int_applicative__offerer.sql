...
select
    ...
    case
        when vgo.first_individual_offer_creation_date is not NULL and vgo.first_collective_offer_creation_date is not NULL then LEAST(vgo.first_collective_offer_creation_date, vgo.first_individual_offer_creation_date)
    ...
    case
        when vgo.last_individual_offer_creation_date is not NULL and vgo.last_collective_offer_creation_date is not NULL then LEAST(vgo.last_collective_offer_creation_date, vgo.last_individual_offer_creation_date)
    ...
    case
        when vgo.first_individual_booking_date is not NULL and vgo.first_collective_booking_date is not NULL then LEAST(vgo.first_collective_booking_date, vgo.first_individual_booking_date)
        else COALESCE(vgo.first_individual_booking_date, vgo.first_collective_booking_date)
    end as first_booking_date,
    case
        when vgo.last_individual_booking_date is not NULL and vgo.last_collective_booking_date is not NULL then LEAST(vgo.last_collective_booking_date, vgo.last_individual_booking_date)
