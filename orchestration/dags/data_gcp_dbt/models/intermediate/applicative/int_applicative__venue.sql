...
select
    ...
    case
        when o.first_individual_booking_date is not NULL and co.first_collective_booking_date is not NULL then LEAST(co.first_collective_booking_date, o.first_individual_booking_date)
        else COALESCE(first_individual_booking_date, first_collective_booking_date)
    end as first_booking_date,
    case
        when o.last_individual_booking_date is not NULL and co.last_collective_booking_date is not NULL then GREATEST(co.last_collective_booking_date, o.last_individual_booking_date)
        else COALESCE(o.last_individual_booking_date, co.last_collective_booking_date)
    end as last_booking_date,
    case
        when o.first_individual_offer_creation_date is not NULL and co.first_collective_offer_creation_date is not NULL then LEAST(co.first_collective_offer_creation_date, o.first_individual_offer_creation_date)
    ...
    case
        when o.last_individual_offer_creation_date is not NULL and co.last_collective_offer_creation_date is not NULL then GREATEST(co.last_collective_offer_creation_date, o.last_individual_offer_creation_date)
