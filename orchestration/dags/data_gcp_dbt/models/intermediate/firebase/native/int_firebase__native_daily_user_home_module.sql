...
consultations as (
    ...
    from consultations_venue as v
        full outer join consultations_offer as o
            on
                o.unique_session_id = v.unique_session_id
