...
select
    ...
    et.offer_context,
    et.offer_origin_id,
    et.model_params_name,
    et.model_params_description,
    et.scorer_retrieval_model_display_name,
    et.scorer_retrieval_model_version,
    et.scorer_ranking_model_display_name,
    et.scorer_ranking_model_version,
