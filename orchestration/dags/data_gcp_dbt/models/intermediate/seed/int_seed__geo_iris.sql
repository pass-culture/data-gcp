...
from iris
left join {{ source("raw", "geo_commune") }} as city on iris.city_code = city.city_code
left join
...
left join
    ...
    on city.commune_code = rural_city_type_data.geo_code
