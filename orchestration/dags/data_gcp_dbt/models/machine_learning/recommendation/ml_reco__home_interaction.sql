...
inner join
    ...
    and filtered_offer_displayed.unique_session_id
    = filtered_home_module.unique_session_id
    and filtered_offer_displayed.event_timestamp
    = filtered_home_module.module_displayed_timestamp
