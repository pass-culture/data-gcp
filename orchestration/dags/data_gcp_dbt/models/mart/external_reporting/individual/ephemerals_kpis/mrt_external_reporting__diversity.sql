...
{% for category in categories %}
    {% for dim in dimensions %}
        ...
        select
            ...
            coalesce(safe_divide(count(distinct bc.user_id), count(distinct user_id)),0) as kpi
...
{% for dim in dimensions %}
    ...
    select
        ...
        coalesce(safe_divide(sum(total_3_category_booked_users), sum(total_users)),0) as kpi
