...
INNER JOIN {{ ref('int_applicative__stock') }} AS stock ON booking.stock_id = stock.stock_id
LEFT JOIN {{ ref('int_applicative__offer') }} AS offer ON offer.offer_id = stock.offer_id
