...
{% endif %}
group by app_install_date, app_id, acquisition_media_source, acquisition_campaign, acquisition_adset, acquisition_ad)
...
inner join
    ...
    and daily_install_cost.acquisition_media_source = daily_attribution_summary.acquisition_media_source
    and daily_install_cost.acquisition_campaign = daily_attribution_summary.acquisition_campaign
    and daily_install_cost.acquisition_adset = daily_attribution_summary.acquisition_adset
