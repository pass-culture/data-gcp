...
select
    ...
    ) as total_grant_18_theoretical_digital_goods_amount_spent,
    sum(
        u.total_non_cancelled_individual_bookings
    ) as total_grant_18_non_cancelled_individual_bookings,
    sum(
        u.total_non_cancelled_duo_bookings
    ) as total_grant_18_non_cancelled_duo_bookings,
