    ...
    return f"""
        CREATE TEMP TABLE collective_booking_ranking_view AS (
            SELECT
                ...
                rank() OVER (PARTITION BY collective_booking.collective_booking_educational_institution_id ORDER BY collective_booking.collective_booking_creation_date) AS collective_booking_rank
...
SELECT
    ...
    , collective_booking.collective_booking_collective_stock_id AS collective_stock_id
    ...
    , collective_booking.collective_booking_educational_redactor_id AS educational_redactor_id
