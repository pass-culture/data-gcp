...
LEFT JOIN collective_offer_humanized_id AS collective_offer_humanized_id ON collective_offer_humanized_id.colletive_offer_id = collective_offer.collective_offer_id
