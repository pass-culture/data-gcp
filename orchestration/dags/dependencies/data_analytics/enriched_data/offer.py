            ...
            SELECT
                ...
                CASE WHEN (offer.offer_subcategoryId <> 'JEU_EN_LIGNE'
                    ...
                    , CASE WHEN offer.offer_id IN (
                        ...
                        FROM {dataset}.enriched_stock_data AS enriched_stock 
                        JOIN {dataset}.{table_prefix}stock AS stock ON stock.stock_id = enriched_stock.stock_id AND NOT stock_is_soft_deleted
