...
historical_clean_applicative_database = {
    "booking_history": {
        ...
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_booking_history${{ yyyymmdd(today()) }}",
    ...
    "collective_booking_history": {
        ...
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_collective_booking_history${{ yyyymmdd(today()) }}",
        "time_partitioning": {"field": "partition_date"},
        "cluster_fields": ["partition_date"],
    },
    "collective_offer_history": {
        "sql": f"{CLEAN_SQL_PATH}/collective_offer_history.sql",
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_collective_offer_history${{ yyyymmdd(today()) }}",
        "time_partitioning": {"field": "partition_date"},
        "cluster_fields": ["partition_date"],
    },
    "collective_stock_history": {
        "sql": f"{CLEAN_SQL_PATH}/collective_stock_history.sql",
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_collective_stock_history${{ yyyymmdd(today()) }}",
        "time_partitioning": {"field": "partition_date"},
        "cluster_fields": ["partition_date"],
    },
    "offer_history": {
        "sql": f"{CLEAN_SQL_PATH}/offer_history.sql",
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_offer_history${{ yyyymmdd(today()) }}",
        "time_partitioning": {"field": "partition_date"},
        "cluster_fields": ["partition_date"],
    },
    "stock_history": {
        "sql": f"{CLEAN_SQL_PATH}/stock_history.sql",
        "destination_dataset_table": "{{ bigquery_clean_dataset }}.applicative_database_stock_history${{ yyyymmdd(today()) }}",
        "time_partitioning": {"field": "partition_date"},
        "cluster_fields": ["partition_date"],
    },
}
