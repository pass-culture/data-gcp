SELECT
    ...
    application_status,
    timestamp_seconds(cast( cast(  last_update_at as INTEGER) / power(10,9) as INTEGER)) as last_update_at,
    timestamp_seconds(cast( cast(  application_submitted_at as INTEGER) / power(10,9) as INTEGER)) as application_submitted_at,
    timestamp_seconds(cast( cast(  passed_in_instruction_at as INTEGER) / power(10,9) as INTEGER)) as passed_in_instruction_at,
    timestamp_seconds(cast( cast(  processed_at as INTEGER) / power(10,9) as INTEGER)) as processed_at,
