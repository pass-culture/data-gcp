SELECT
    ...
    application_status,
    timestamp_seconds(cast( last_update_at as INTEGER)) as last_update_at,
    timestamp_seconds(cast( application_submitted_at as INTEGER)) as application_submitted_at,
    timestamp_seconds(cast( passed_in_instruction_at as INTEGER)) as passed_in_instruction_at,
    timestamp_seconds(cast( processed_at as INTEGER)) as processed_at,
