...
get_recommendable_offers AS (
    SELECT
        ...
        glt_mapping.gtl_label_level_1 AS gtl_label_level_1,
        glt_mapping.gtl_label_level_2 AS gtl_label_level_2,
        glt_mapping.gtl_label_level_3 AS gtl_label_level_3,
        glt_mapping.gtl_label_level_4 AS gtl_label_level_4,
