...
recommendable_offers_data AS (
    ...
    FROM (
        SELECT 
            ...
            MAX(gtl_label_level_1) AS gtl_label_level_1,
            MAX(gtl_label_level_2) AS gtl_label_level_2,
            MAX(gtl_label_level_3) AS gtl_label_level_3,
            MAX(gtl_label_level_4) AS gtl_label_level_4,
...
SELECT
    ...
    ro.name,
    ro.gtl_id,
    ro.gtl_label_level_1,
    ro.gtl_label_level_2,
    ro.gtl_label_level_3,
    ro.gtl_label_level_4,
    ro.is_numerical,
    ro.is_national,
    ro.is_geolocated,
