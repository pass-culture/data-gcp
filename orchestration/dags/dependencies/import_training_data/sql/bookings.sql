...
group by booking.user_id, offer.offer_id, offer_product_id,offer_categoryId, offer_subcategoryid,enroffer.genres, enroffer.rayon, enroffer.type, enroffer.venue_id, enroffer.venue_name