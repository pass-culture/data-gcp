SELECT
    ...
    jsonPayload.extra.newlysubscribedto.themes AS newly_subscribed_themes,
    ...
    jsonPayload.extra.subscriptions.subscribed_themes AS currently_subscribed_themes,
    ...
    jsonPayload.extra.newlyunsubscribedfrom.themes AS newly_unsubscribed_themes,
