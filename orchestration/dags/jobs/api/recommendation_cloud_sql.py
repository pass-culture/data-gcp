...
with DAG(
    ...
    recreate_indexes_query = """
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS idx_offer_recommendable_id       ON public.recommendable_offers_per_iris_shape           USING btree (offer_id, stock_beginning_date);
        CREATE UNIQUE INDEX IF NOT EXISTS idx_offer_recommendable_15_id    ON public.recommendable_offers_per_iris_shape_eac_15    USING btree (offer_id,stock_beginning_date);
        CREATE UNIQUE INDEX IF NOT EXISTS idx_offer_recommendable_16_17_id ON public.recommendable_offers_per_iris_shape_eac_16_17 USING btree (offer_id,stock_beginning_date);
    ...
    views_to_refresh = [
        ...
        "recommendable_offers_per_iris_shape_eac_15",
        "recommendable_offers_per_iris_shape_eac_16_17",
