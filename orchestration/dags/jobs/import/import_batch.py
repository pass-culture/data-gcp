...
with DAG(
    ...
    ios_job = GCloudSSHGCEOperator(
        ...
        base_dir=BASE_PATH,
        command=f"""
        python main.py --operating_system=ios --gcp_project_id={GCP_PROJECT_ID} --env_short_name={ENV_SHORT_NAME}        
        """,
    )
    ...
    android_job = GCloudSSHGCEOperator(
        ...
        base_dir=BASE_PATH,
        command=f"""
        python main.py --operating_system=android --gcp_project_id={GCP_PROJECT_ID} --env_short_name={ENV_SHORT_NAME}        
        """,
    )
