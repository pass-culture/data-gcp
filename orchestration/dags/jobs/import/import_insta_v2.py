...
with DAG(
    ...
    params={
        "branch": Param(
            default="DE-2183-refactor-insta-import",  # "production" if ENV_SHORT_NAME == "prod" else "master",
            type="string",
        ),
        "n_days": Param(
            default=-14,
    ...
    for social_network in ["instagram"]:
        gce_instance = f"import-{social_network}-{ENV_SHORT_NAME}-v2"
        base_path = f"data-gcp/jobs/etl_jobs/"
        ...
        fetch_install_code = InstallDependenciesOperator(
            ...
            instance_name=gce_instance,
            requirement_file="jobs/instagram/requirements.txt",
