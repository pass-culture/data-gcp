...
with DAG(
    ...
    import_historical_answers_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table="{{ gcp_project_id }}.{{ bigquery_raw_dataset }}.qpi_answers_historical",
    ...
    import_answers_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table="{{ gcp_project_id }}.{{ bigquery_tmp_dataset }}.{{ ds_nodash }}_qpi_answers_v4",
        write_disposition="WRITE_TRUNCATE",
