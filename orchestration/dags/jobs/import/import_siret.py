...
SIRET_ENV_VARS = {"PROJECT_NAME": GCP_PROJECT_ID}
...
with DAG(
    ...
    description="Import SIRET from INSEE API",
    ...
    siret_to_bq_task = CustomKubernetesPodOperator(
        task_id="siret_to_bq",
