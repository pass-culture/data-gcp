...
dag_config = {
    "STORAGE_PATH": f"gs://{MLFLOW_BUCKET_NAME}/algo_training_{ENV_SHORT_NAME}/algo_training_v2_baseline_two_tower_{DATE}",
    "BASE_DIR": f"data-gcp/algo_training/two_towers_training",
    "TRAIN_DIR": "/home/airflow/train",
    "EXPERIMENT_NAME": f"algo_training_v2_baseline_two_tower.1_{ENV_SHORT_NAME}",
}

# Params
train_params = {
    "config_file_name": "baseline-features",
    "batch_size": 4096,
...
gce_params = {
    "instance_name": f"algo-training-v2-baseline-two-tower-{ENV_SHORT_NAME}",
    "instance_type": {
        "dev": "n1-standard-2",
        "stg": "n1-standard-8",
        "prod": "n1-standard-16",
...
with DAG(
    "algo_training_v2_baseline_two_tower",
    default_args=default_args,
    description="Baseline Two Towers training job",
    ...
    training = SSHGCEOperator(
        ...
        base_dir=dag_config["BASE_DIR"],
        environment=dag_config,
        command=f"python train_baseline.py "
        "--config-file-name {{ params.config_file_name }} "
