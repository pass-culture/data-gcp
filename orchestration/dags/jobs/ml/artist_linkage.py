...
with DAG(
    ...
    embed_offer_names_on_namesakes = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        command=f"""
             uv run python main.py linkage embed-offer-names \
    ...
    deduplicate_artists = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        command=f"""
             uv run python main.py linkage deduplicate \
    ...
    link_new_products_to_artists = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        command=f"""
             uv run python main.py linkage link-new-products \
    ...
    refresh_artist_metadatas = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        command=f"""
             uv run python main.py linkage refresh-metadata \
    ...
    get_wikimedia_commons_license = SSHGCEOperator(
        ...
        trigger_rule="none_failed_min_one_success",
        command=f"""
             uv run python main.py similarity get-wikimedia-license \
    ...
    transfer_wikimedia_images_to_gcs = SSHGCEOperator(
        ...
        trigger_rule="none_failed_min_one_success",
        command=f"""
             uv run python main.py similarity transfer-images \
    ...
    get_wikipedia_page_content = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        trigger_rule="none_failed_min_one_success",
        command="uv run python main.py similarity get-wikipedia-content "
    ...
    summarize_biographies_with_llm = SSHGCEOperator(
        ...
        base_dir=BASE_DIR,
        command=f"""
             uv run python main.py similarity summarize-biographies \
