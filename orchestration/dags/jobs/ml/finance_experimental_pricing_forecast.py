...
dag_config = {
    "STORAGE_PATH": f"gs://{ML_BUCKET_TEMP}/ml_finance_experimental_pricing_forecast/{ENV_SHORT_NAME}/{DATE}",
    "BASE_DIR": "data-gcp/jobs/ml_jobs/finance",
}

# Params
gce_params = {
    "instance_name": f"ml-finance-experimental-pricing-forecast-{ENV_SHORT_NAME}",
    "instance_type": {
        "dev": "n1-standard-2",
        "stg": "n1-standard-4",
        "prod": "n1-standard-4",
