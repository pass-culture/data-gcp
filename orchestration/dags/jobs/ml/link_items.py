...
dag_config = {
    ...
    "output-lancedb-table-path": "metadata/vector",
    "output-linkage-candidates-table-path": "linkage_candidates_items",
}
...
with DAG(
    ...
    params={
        ...
        "output_lancedb_table_path": Param(
            default=dag_config["output_lancedb_table_path"],
            type="string",
        ),
    ...
    build_linkage_vector = SSHGCEOperator(
        ...
        f"--output-table-path {dag_config['output_lancedb_table_path']}",
        dag=dag,
    )
