...
def test_get_final_recommendation_for_group_a(
    ...
    get_intermediate_recommendations_for_user_mock.return_value = [
        {"id": 2, "url": "url2", "type": "type2", "item_id": "offer-2","product_id": "product-2"},
        {"id": 3, "url": "url3", "type": "type3", "item_id": "offer-3","product_id": "product-3"},
    ]
    get_scored_recommendation_for_user_mock.return_value = [
        {"id": 2, "url": "url2", "type": "type2", "item_id": "offer-2","product_id": "product-2", "score": 2},
        {"id": 3, "url": "url3", "type": "type3", "item_id": "offer-3","product_id": "product-3", "score": 3},
    ]
...
def test_get_intermediate_recommendation_for_user(setup_database: Any):
    ...
    assert_array_equal(
        ...
        [
            {"id": "2", "type": "B", "url": None, "item_id": "offer-2","product_id": "product-2"},
            {"id": "3", "type": "C", "url": "url", "item_id": "offer-3","product_id": "product-3"},
            {"id": "5", "type": "E", "url": None, "item_id": "offer-5","product_id": "product-5"},
            {"id": "6", "type": "B", "url": None, "item_id": "offer-6","product_id": "product-6"},
        ],
    )
...
def test_get_intermediate_recommendation_for_user_with_no_iris(
    ...
    assert_array_equal(
        sorted(user_recommendation, key=lambda k: k["id"]),
        [
            {"id": "1", "type": "A", "url": None, "item_id": "offer-1", "product_id": "product-2"},
            {"id": "3", "type": "C", "url": "url", "item_id": "offer-3", "product_id": "product-3"},
            {"id": "4", "type": "D", "url": "url", "item_id": "offer-4", "product_id": "product-4"},
            {"id": "5", "type": "E", "url": None, "item_id": "offer-5", "product_id": "product-5"},
        ],
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            [
                {"id": 1, "url": None, "type": "A", "item_id": "offer-1", "product_id": "product-1", "score": 1},
                {"id": 2, "url": None, "type": "A", "item_id": "offer-2", "product_id": "product-2", "score": 1},
                {"id": 3, "url": None, "type": "B", "item_id": "offer-3", "product_id": "product-3", "score": 10},
                {"id": 4, "url": None, "type": "B", "item_id": "offer-4", "product_id": "product-4","score": 10},
            ],
            [4, 2, 3, 1],
        ),
        (
            [
                {"id": 1, "url": None, "type": "A", "item_id": "offer-1", "product_id": "product-1", "score": 1},
                {"id": 2, "url": None, "type": "A", "item_id": "offer-2", "product_id": "product-2", "score": 2},
                {"id": 3, "url": None, "type": "A", "item_id": "offer-3", "product_id": "product-3", "score": 10},
                {"id": 4, "url": None, "type": "A", "item_id": "offer-4", "product_id": "product-4", "score": 11},
            ],
            [4, 3, 2, 1],
        ),
    ],
...
def test_get_scored_recommendation_for_user(
    ...
    user_recommendation = [
        {"id": 1, "url": "url1", "type": "type1", "item_id": "offer-1","product_id": "product-1"},
        {"id": 2, "url": "url2", "type": "type2", "item_id": "offer-2","product_id": "product-2"},
        {"id": 3, "url": "url3", "type": "type3", "item_id": "offer-3","product_id": "product-3"},
    ]
    ...
    assert scored_recommendation_for_user == [
        {"id": 1, "url": "url1", "type": "type1", "item_id": "offer-1","product_id": "product-1", "score": 1},
        {"id": 2, "url": "url2", "type": "type2", "item_id": "offer-2","product_id": "product-2", "score": 2},
        {"id": 3, "url": "url3", "type": "type3", "item_id": "offer-3","product_id": "product-3", "score": 3},
    ]
