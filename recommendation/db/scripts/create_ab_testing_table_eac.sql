...
CREATE TABLE IF NOT EXISTS public.abc_testing_20211214_v1v2_eac (userId varchar, groupId text);
INSERT INTO public.abc_testing_20211214_v1v2_eac (userId, groupId)(
...
UPDATE abc_testing_20211214_v1v2_eac set groupid = 'A' where userid = '1';
UPDATE abc_testing_20211214_v1v2_eac set groupid = 'B' where userid = '2';
UPDATE abc_testing_20211214_v1v2_eac set groupid = 'C' where userid = '3';

CREATE INDEX ab_testing_user_id_eac ON public.abc_testing_20211214_v1v2_eac USING btree (userId);
