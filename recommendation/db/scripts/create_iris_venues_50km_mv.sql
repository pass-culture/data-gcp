...
DROP FUNCTION IF EXISTS get_iris_venues_50km_50km CASCADE;
CREATE OR REPLACE FUNCTION get_iris_venues_50km()
...
BEGIN
    ...
    FROM public.iris_venues_50km v;
END;
$body$
LANGUAGE plpgsql;


CREATE MATERIALIZED VIEW IF NOT EXISTS iris_venues_50km_mv
AS
    SELECT * from get_iris_venues_50km()
WITH NO DATA;

CREATE UNIQUE INDEX idx_iris_venues_50km_mv_irisid ON public.iris_venues_50km_mv USING btree (iris_id,venue_id);
REFRESH MATERIALIZED VIEW iris_venues_50km_mv;
