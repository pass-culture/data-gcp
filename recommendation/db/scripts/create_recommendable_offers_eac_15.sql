...
CREATE OR REPLACE FUNCTION get_recommendable_offers_per_iris_shape_eac_15()
RETURNS TABLE (
    item_id varchar,
    offer_id varchar,
    product_id varchar,
...
DROP MATERIALIZED VIEW IF EXISTS recommendable_offers_per_iris_shape_eac_15;
CREATE MATERIALIZED VIEW IF NOT EXISTS recommendable_offers_per_iris_shape_eac_15 AS
SELECT * FROM get_recommendable_offers_per_iris_shape_eac_15()
WITH NO DATA;
...
CREATE UNIQUE INDEX idx_offer_recommendable_15_id ON public.recommendable_offers_per_iris_shape_eac_15 USING btree (offer_id,stock_beginning_date);
REFRESH MATERIALIZED VIEW recommendable_offers_per_iris_shape_eac_15;
