...
def test_updated_offer_in_recommendable_offers(setup_database, query, name, recommendable):
    """
...
def test_updated_offer_in_non_recommendable_offers(setup_database, query, name, recommendable):
    """
    Test that an update on the (initially recommendable) offer data
    has the expected impact on its recommendable status and its presence in
